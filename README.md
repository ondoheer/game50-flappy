...
This is the [assignment](https://docs.cs50.net/games/2020/x/assignments/1/assignment1.html) for the CS50 Game Development course.
...
- Randomize the interval at which pairs of pipes spawn, such that they’re no longer always 2 seconds apart.
  ...
  - Randomize GAP_HEIGHT constant
  - Randomize PipePair appearance on the PayState:update function (it's a constant 2 right now)
